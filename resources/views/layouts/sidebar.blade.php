...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        <img src="{{ asset('LTE') }}/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
            style="opacity: .8">
        <span class="brand-text font-weight-light">FiqssApp</span>
    </a>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
             ...
             with font-awesome or any other icon font library -->
                ...
                <li class="nav-item {{ ($title == 'barangmasuk' || $title == 'Vendor'  || $title == 'databarang') ? 'menu-is-opening menu-open' : ''}}">
                    <a class="nav-link {{ ($title == 'barangmasuk' || $title == 'Vendor'  || $title == 'databarang') ? 'active ' : ''}}">
                    ...
                    <ul class="nav nav-treeview" style="display: {{ ($title == 'barangmasuk' || $title == 'Vendor' || $title == 'databarang') ? 'block' : 'none' }}">

                        <li class="nav-item">
                            <a href="/barangmasuk" class="nav-link {{ $title == 'barangmasuk' ? 'active ' : ''}}">
